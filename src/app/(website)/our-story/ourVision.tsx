      ...
      <div className='bg-[#890D8B0D] rounded-2xl md:py-10'>
        <div className='grid md:grid-flow-col justify-between'>
          <div className=' relative p-8'>
            <h5 className='text-[#890D8B] font-bold font-inter  text-lg md:text-[2.5rem] md:w-8/12'>
              Our Vision
            </h5>
            <p className='font-medium font-inter md:text-2xl text-[#000000] mt-9 md:w-10/12'>
