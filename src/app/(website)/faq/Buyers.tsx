            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {showFaq === i ? (
                    <IoChevronUp className='text-[#570059]  cursor-pointetext-xl md:mt-0 mt-1' />
                  ) : (
                    <IoChevronDown className='text-[#570059] cursor-pointe text-xl md:mt-0 mt-1' />
                  )}
                </div>
                {/* Answer Section */}
                {showFaq === i && (
                  <div className='mt-3 transition-all duration-300 cursor-pointer ease-in-out'>
